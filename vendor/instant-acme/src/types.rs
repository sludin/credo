...
pub struct Challenge {
    ...
    pub url: String,
    /// Token for this challenge (absent on some non-standard challenge types)
    #[serde(default)]
    pub token: String,
    /// Current status
...
pub enum ChallengeType {
    ...
    TlsAlpn01,
    /// Any challenge type not recognised by this library (e.g. dns-persist-01).
    /// Challenges of this type are ignored by the issuance flow.
    #[serde(other)]
    Unknown,
}
